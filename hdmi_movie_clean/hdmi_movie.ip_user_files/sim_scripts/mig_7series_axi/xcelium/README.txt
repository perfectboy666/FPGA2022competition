...
#
# Generated by export_simulation on Sun Oct 23 22:06:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mig_7series_axi.sh' script.

./mig_7series_axi.sh -reset_run
...
./mig_7series_axi.sh -noclean_files

For more information on the script, please type './mig_7series_axi.sh -help'.
