...
#
# Generated by export_simulation on Tue Nov 01 21:31:41 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Line_shift_ram_1bit.sh' script.

./Line_shift_ram_1bit.sh -reset_run
...
./Line_shift_ram_1bit.sh -noclean_files

For more information on the script, please type './Line_shift_ram_1bit.sh -help'.
