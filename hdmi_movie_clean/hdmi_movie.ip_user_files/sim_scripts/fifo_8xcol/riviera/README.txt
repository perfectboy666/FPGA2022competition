...
#
# Generated by export_simulation on Sun Oct 23 22:04:22 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_8xcol.sh' script.

./fifo_8xcol.sh -reset_run
...
./fifo_8xcol.sh -noclean_files

For more information on the script, please type './fifo_8xcol.sh -help'.
