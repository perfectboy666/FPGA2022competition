...
assign  cfg_array[056]  =       {8'h78, 16'h4300, 8'h61};
...
assign  cfg_array[208]  =       {8'h78, 16'h3035, 8'h41};
assign  cfg_array[209]  =       {8'h78, 16'h3036, 8'h69};
assign  cfg_array[210]  =       {8'h78, 16'h3c07, 8'h07};
assign  cfg_array[211]  =       {8'h78, 16'h3820, 8'h46};
assign  cfg_array[212]  =       {8'h78, 16'h3821, 8'h01};
...
assign  cfg_array[218]  =       {8'h78, 16'h3803, 8'hfa};
assign  cfg_array[219]  =       {8'h78, 16'h3804, 8'h0a};
assign  cfg_array[220]  =       {8'h78, 16'h3805, 8'h3f};
assign  cfg_array[221]  =       {8'h78, 16'h3806, 8'h06};
assign  cfg_array[222]  =       {8'h78, 16'h3807, 8'ha9};
assign  cfg_array[223]  =       {8'h78, 16'h3808, 8'h01};
assign  cfg_array[224]  =       {8'h78, 16'h3809, 8'hE0};
assign  cfg_array[225]  =       {8'h78, 16'h380a, 8'h01};
assign  cfg_array[226]  =       {8'h78, 16'h380b, 8'h10};
assign  cfg_array[227]  =       {8'h78, 16'h380c, 8'h07};
assign  cfg_array[228]  =       {8'h78, 16'h380d, 8'h64};
assign  cfg_array[229]  =       {8'h78, 16'h380e, 8'h02};
assign  cfg_array[230]  =       {8'h78, 16'h380f, 8'he4};
assign  cfg_array[231]  =       {8'h78, 16'h3813, 8'h04};
...
assign  cfg_array[236]  =       {8'h78, 16'h3a02, 8'h02};
assign  cfg_array[237]  =       {8'h78, 16'h3a03, 8'he0};
assign  cfg_array[238]  =       {8'h78, 16'h3a08, 8'h00};
assign  cfg_array[239]  =       {8'h78, 16'h3a09, 8'h6f};
assign  cfg_array[240]  =       {8'h78, 16'h3a0a, 8'h00};
assign  cfg_array[241]  =       {8'h78, 16'h3a0b, 8'h5c};
assign  cfg_array[242]  =       {8'h78, 16'h3a0e, 8'h06};
assign  cfg_array[243]  =       {8'h78, 16'h3a0d, 8'h08};
assign  cfg_array[244]  =       {8'h78, 16'h3a14, 8'h02};
assign  cfg_array[245]  =       {8'h78, 16'h3a15, 8'he0};

assign  cfg_array[246]  =       {8'h78, 16'h4004, 8'h02};
assign  cfg_array[247]  =       {8'h78, 16'h3002, 8'h1c};
assign  cfg_array[248]  =       {8'h78, 16'h3006, 8'hc3};
assign  cfg_array[249]  =       {8'h78, 16'h4713, 8'h03};
assign  cfg_array[250]  =       {8'h78, 16'h4407, 8'h04};
assign  cfg_array[251]  =       {8'h78, 16'h460b, 8'h37};
assign  cfg_array[252]  =       {8'h78, 16'h460c, 8'h20};
assign  cfg_array[253]  =       {8'h78, 16'h4837, 8'h16};
assign  cfg_array[254]  =       {8'h78, 16'h3824, 8'h04};
assign  cfg_array[255]  =       {8'h78, 16'h5001, 8'h83};
assign  cfg_array[256]  =       {8'h78, 16'h3503, 8'h00};
//debug	mode
//assign  cfg_array[304]  =       {8'h78, 16'h503d, 8'h80};
//assign  cfg_array[305]  =       {8'h78, 16'h4741, 8'h00};
//-----------------------------------------------------------------------------
